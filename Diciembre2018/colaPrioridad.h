...
void crear(TColaPrio cp); //char* nombre como primer argumento. Por que?

/**
 * Dada una prioridad y un identificador de proceso,
 * lo a�ade AL FINAL de la lista que le corresponde.
 */
void nuevoProceso (TColaPrio cp,int p, int id);//funciona
 ...
 *
 */
void mostrar(TColaPrio cp);	//funciona
